...
const gameModule = (() => {
    ...
    function resetGameLevel() {
        gameState.levelsInfo.currentLevel = 0;
    }
    ...
    function changeSoundState() {
        (gameState.sound) ? gameState.sound = false : gameState.sound = true;
    }
...
const controller = ((game, view) => {
    ...
    function initGame() {
        ...
        // Music button
        var musicMuteFlag = false;
        var gameBgm = game.getBackGroundMusic();
        const musicButton = document.querySelector(view.DOMStrings.gameMusic);
